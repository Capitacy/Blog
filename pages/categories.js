            ...
            <div>
                ...
                <main>
                    ...
                    <div className="post-meta">
                        <p className="date-author"><FontAwesome className="sm-margin" name='file-text-o' />{this.props.data.category.description == "" ? "(no description provided)" : this.props.data.category.description}</p>
